...
3. 复现 DAMMFND/MMDFND 官方代码，而不是只引用 reported baseline。
4. 做 per-domain error analysis，重点看 Weibo 的 Science/Politics/Entertainment/Society 与 Weibo-21 的 Health/Finance/Society 域。
