...
若继续方法创新，下一步必须提出本质不同机制：解释 static aux 2.0、utility-only / entropy-only allocation、reverse-utility UEA control 的训练动力学，并避免把 low-margin / risk 直接当 hard trust gate。
